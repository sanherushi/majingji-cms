								...
								<li class="nav-item"><a
									...
									<c:forEach items="${categorys}" var="c">
										<li class="nav-item"><a
											...
											cms-list-group-item-active":"" }" href="/?channelId=${article.channelId}&categoryId=${c.id}"
											onclick="category(${c.id})">${c.name}</a> <input
				...
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
						<c:forEach items="${picInfo.list }" var="p">
							<div class="media">
								<img src="/pic/${p.picture }" class="mr-3 rounded" alt="..."
				...
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
						<c:forEach items="${linksInfo.list }" var="l">
							<a href="${l.url }" target="_blank">${l.text }</a><br>
						</c:forEach>
					</div>
				</div>
